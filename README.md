...
# agrid A grid for modelling, analysing, mapping and visualising multidimensional and multivariate data. The module contains a class for generating grid objects with variables and functions that define a multidimensional space with a defined extent. 
...
The repository contains: 
 - A Module with a class for functions and variables. 
...
Software paper available here: [JORS](https://openresearchsoftware.metajnl.com/articles/10.5334/jors.287/)
...
**Alternative 2**
Download the module and import the agrid from the local path
...
Data can be exported and saved as netCDF, raster files, or text files. 
...
If used in publication, please consider citing:
